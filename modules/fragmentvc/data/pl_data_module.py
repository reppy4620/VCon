...
from .dataset import FragmentVCDataset


class FragmentVCDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.train_x, self.valid_x = FragmentVCDataset(train), FragmentVCDataset(valid)
